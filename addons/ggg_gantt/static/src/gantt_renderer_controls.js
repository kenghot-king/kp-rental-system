...
export class GanttRendererControls extends Component {
    static template = "ggg_gantt.GanttRendererControls";
    static components = {
        Dropdown,
        DropdownItem,
        GanttScaleSelector,
    ...
    static toolbarContentTemplate = "ggg_gantt.GanttRendererControls.ToolbarContent";
    static rangeMenuTemplate = "ggg_gantt.GanttRendererControls.RangeMenu";
