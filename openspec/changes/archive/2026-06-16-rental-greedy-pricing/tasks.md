...
- [X] 3.1 Restart Odoo and upgrade `ggg_rental`; confirm no import or registry errors in logs
- [X] 3.2 Create a rental order with [12d @ 500฿, 7d @ 300฿, 1d @ 50฿] and 22-day duration; confirm price = 950฿
- [X] 3.3 Create a rental order with the same product for 7 days; confirm price = 300฿ (exact weekly boundary)
- [X] 3.4 Create a rental order with [12d @ 500฿, 7d @ 300฿] (no daily) for 22 days; confirm price = 1,100฿ (1×500 + 2×300)
- [X] 3.5 Create a rental order with a single [1d @ 50฿] rule for 9 days; confirm price = 450฿
